...
shuffleArray(userGrowthData.datasets[0].data);
shuffleArray(userGrowthData.datasets[1].data);
shuffleArray(revenueDistributionData.datasets[0].data);
shuffleArray(topSongsData.datasets[0].data);
